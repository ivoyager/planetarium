...
func _ready() -> void:
	...
	mod.init_min_size(IVGlobal.GUISize.GUI_SMALL, Vector2(435.0, 278.0))
	mod.init_min_size(IVGlobal.GUISize.GUI_MEDIUM, Vector2(575.0, 336.0))
	mod.init_min_size(IVGlobal.GUISize.GUI_LARGE, Vector2(712.0, 400.0))
